...
class ResnetEncoder_Teacher(nn.Module):
    """Pytorch module for a resnet encoder
    """
    def __init__(self, num_layers, pretrained, num_input_images=1):
        super(ResnetEncoder_Teacher, self).__init__()
...
class Initial_teacher(nn.Module):
    def __init__(self):
        super(Initial_teacher, self).__init__()
        
        self.initial_layer = nn.Conv2d(28, 64, kernel_size = (7, 7), stride = (2, 2), padding = (3, 3), bias = False)
